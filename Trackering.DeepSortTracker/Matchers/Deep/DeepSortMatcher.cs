using Tracing.DeepSortTracker.Utils.Algorithms.Hungarian;
using Tracing.DeepSortTracker.Utils.Pool;
using Tracing.DeepSortTracker.Utils;
using System.Drawing;
using System.Linq;
using Tracing.DeepSortTracker.Utils.DataStructs;
using Tracing.DeepSortTracker.Matchers.Abstract;
using System.Runtime.CompilerServices;
using Tracing.DeepSortTracker.Matchers.Trackers;
...
namespace Tracing.DeepSortTracker.Matchers.Deep
{
    public class DeepSortMatcher : Matcher
    {
        ...
        public override IReadOnlyList<ITrack> Run(Bitmap frame, IPrediction[] detectedObjects)
        {
            ...
            stopwatch.Start();
            Trace.TraceInformation($"Pridictions: {detectedObjects.Length}");
